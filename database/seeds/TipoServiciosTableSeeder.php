    ...
    public function run()
    {
        ...
        DB::table('tipo_servicios')->insert([
            [
                ...
                'modalidad'     => 'Unidad Motrices y Remolques, Transfronterizo de carga, Unidad Motrices Y Remolques, Gruas de Arrastre, Salvamento e Industriales',
                'expresion'     => '/^(\d{2})([A-H,J-N,P-Z]{2})(\d{1})([A-H,J-N,P-Z]{1})$/',
                'caracteres'    => '00AA0A',
                'longitud'      => 6
            ],
            [
                'tipo_servicio' => 'Autotransporte Federal, Transporte Privado CDMX, Autotransporte Federal (2000)',
                'modalidad'     => 'Transfronterizo de pasaje, Camiones, Transfronterizo de pasaje',
                'expresion'     => '/^([A-H,J-N,P-Z]{1})(\d{3})([A-H,J-N,P-Z]{2})$/',
                'caracteres'    => 'A000AA',
                'longitud'      => 6
            ],
            [
                'tipo_servicio' => 'Autotransporte Federal, Publico Local CDMX',
                'modalidad'     => 'Pasaje Economico y Mixto, Alibre y sitio',
            ...
            [
                'tipo_servicio' => 'Autotransporte Federal',
                'modalidad'     => 'Traslado Nacional Vehiculo, Paquetería y Mensajeria',
            ...
            [
                'tipo_servicio' => 'Autotransporte Federal, Autotransporte Federal (2000)',
                'modalidad'     => 'Capacidad diferentes, Discapacitados',
            ...
            [
                'tipo_servicio' => 'Autotransporte Federal, Transporte Privado CDMX, Público Local (Distrito Federal 2000), Transporte Privado Entidades Federativas',
                'modalidad'     => 'Convertidor, Convertidor (Dolly), Libre y Sitio',
                'expresion'     => '/^([A-H,J-N,P-Z]{1})(\d{5})$/',
                'caracteres'    => 'A00000',
                'longitud'      => 6
            ],
            [
                'tipo_servicio' => 'Autotransporte Federal, Transportes Privados (2000), Transportes Privados (Autos Antiguos 2000), Inspección de Vías Generales de Comunicación',
                'modalidad'     => 'Inspección de Vias Generales de Comunicación Federal, Demostración, Distrito Federal (Todo tipo de vehiculos), Entidades Federativas, SCT',
            ...
            [
                'tipo_servicio' => 'Transporte Privado Fronterizo, Transporte Privado Entidades Federativas',
                'modalidad'     => 'Camiones, Autobuses y Remolques, Automoviles',
                'expresion'     => '/^([A-H,J-N,P-Z]{3})(\d{3})([A-H,J-N,P-Z]{1})$/',
                'caracteres'    => 'AAA000A',
                'longitud'      => 7
            ],
            [
                'tipo_servicio' => 'Publico Local, Publico Local Entidades Federativas',
            ...
            [
                'tipo_servicio' => 'Policía Federal, Transporte Privado Entidades Federativas',
                'modalidad'     => 'Patrullas de todo tipo de vehiculos, Camiones',
            ...
            [
                'tipo_servicio' => 'Publico Local CDMX, Público Local (Distrito Federal 2000)',
            ...
            [
                'tipo_servicio' => 'Ambulancias, Bomberos',
                'modalidad'     => 'CDMX y EF',
            ...
            [
                ...
                'modalidad'     => 'Coordinación Nacional de Proteccion Civil, CDMX y EF',
            ...
            [
                ...
                'expresion'     => '/^(\d{3})([A-H,J-N,P-Z]{2})(\d{1})$/',
                'caracteres'    => '000AA0',
                'longitud'      => 6
            ],
            [
                'tipo_servicio' => 'Autotransporte Federal (2000), Transportes Privados (2000)',
                'modalidad'     => 'Transfronterizo de carga, Demostración Entidades Federativas (Todo tipo de vehiculos)',
            ...
            [
                'tipo_servicio' => 'Autotransporte Federal (2000), Transportes Privados (Distrito Federal 2000)',
                'modalidad'     => 'Traslado Nacional (Para todo tipo de vehiculos), Camiones',
            ...
            [
                'tipo_servicio' => 'Transportes Privados Fronterizos (2000), Transportes Privados (Entidades Federativas 2000)',
                'modalidad'     => 'Camiones, Autobuses y Remolques, Automoviles',
            ...
            [
                'tipo_servicio' => 'Público Local Fronterizos (2000), Público Local (Entidades Federativas 2000)',
                'modalidad'     => 'Automóviles, Camiones, Autobuses y Remolques, Automoviles',
