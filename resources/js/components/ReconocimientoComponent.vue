    ...
    <div id="rec" class=" box row">
        <div>
            <form id="formvalidacion" name="formulariovalidacion">
                ...
                <div name="caracteres" style="display:grid">
                    <input type="text"  name="PlacaEdit" id="idEdit" maxlength="8" minlength="5"  class="uppercase" >
                </div>
                ...
                <div class="row rowButtons">
                    <div class="col-lg-4 col-md-4 col-xs-4 col-sm-4" name="btnform-descartar2" id="btnDivDescartar">
                        <button class="btn btn-defaul btn-md" id="buttondescartar2" name="buttondescartar2" type="button" onclick="descarta();"> Descartar </button>
                        <!-- MENSAJES DE VALIDACIÓN -->
                        <div class="errorPlaca" style="margin-top: 5%; margin-left: 10%;" >
                            <label id="msjerror1" class="error esconder"></label>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-xs-4 col-sm-4"  name="btnform-firmar" id="btncambiar">
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-4 col-sm-4"  name="btnform-edicion"i d="refcambiar"  >
...
export default {
    ...
    mounted() {
        //this.getImagen();
        this.$root.$on('set_input',(res)=> {
            this.input = res
            //console.log(" Reconocimiento",this.input);
            $('#idEdit').val(this.input.placa_original);
        })
