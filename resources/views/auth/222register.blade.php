...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8" >
            <div class="card" style="background-color: #525657 !important;color: white;border:1px solid white; ">
                <div class="card-header" style="background-color: white;border:1px solid gray;">{{ __('Register') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}" >
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="background-color:#fb0000; border:1px solid #fb0000;">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
